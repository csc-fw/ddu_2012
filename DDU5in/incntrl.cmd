...
vector next_f NEXT_F[7:0]   | in_unit
vector wrnext_f WRNEXT_F[7:0] | in_unit
...
|
vector reg_en0 $1I4143\REG_EN
vector bram0_mt $1I4143\MT
vector mem0_mt $1I4143\MT_OUT
vector mem0cnt $1I4143\$1I4488\CNT[10:0]
vector mem0wadr $1I4143\$1I4488\WADR[10:0]
vector mem0radr $1I4143\$1I4488\RADR[9:0]
|
vector owen0 ~OWEN0
vector in $1I4156\IN[35:0]
vector out $1I4156\OUT[35:0]
vector selout $1I4156\SELOUT[35:0]
vector dout DO[39:0]
|
|vector wr_sel8 $4I4630\WR_SEL
|vector wen8 $4I4630\WEN
|vector nearend8 $4I4630\NEAR_END
|vector switch8 $4I4630\SWITCH_NOW
|
|
wave inctrl_0.wfm rst fok l1a m_mt0 mt_m fr0mem clk memreq newmem newenb asf mark wrnext_f next_f fpaf none_free memavail oldctrl free rst0complete in0rdy in0dat in1dat wen_f af_f full_f clk40 l1a0mt data_rdy push evtcnt rdat busy startd ren_f oem ren0 foeren oefifo oef_f reg_en0 bram0_mt mem0_mt mem0cnt mem0wadr mem0radr clk80 clkout lren dmbdav dofw+1 ren_toggle next_fiber oe_hdr gooddataen golddat oefok lfifo_mt nnd moredata dodata done_data lw_in renoe-0 fdone done endevt owen0 in out selout dout
...
| Now put in data: in1dat & i1kin 0\h, then set rdat accordingly
